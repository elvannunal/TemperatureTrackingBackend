...
- 
- ## 🗄️ Veritabanı Kayıtları (PostgreSQL)

Sistem, 80°C üzerindeki tüm sıcaklık değişimlerini gerçek zamanlı olarak takip eder ve PostgreSQL veritabanına "Alarm Logu" olarak kaydeder. Aşağıda, sistemin ürettiği örnek alarm kayıtları görülmektedir:
